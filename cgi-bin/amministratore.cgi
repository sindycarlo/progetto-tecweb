...
<head>
  ...
  <meta name="title" content="2forchette - Login Amministratore"/>
...
<body>
<div><a class="salta-main" href="#login-form"><span>Salta al contenuto</span></a></div>
<div id="header">
  <div class="main">
...
<div id="content">
  <div class="main">
    ...
    <form id="login-form" action="check_admin.cgi" method="post">
      <div id="fieldset">
        
         
            <div class="form-txt"><span xml:lang="en">Login </span></div>
            <label>
         ...
         <div class="buttons"><div class="button"><input type="submit"/></div><div class="button"><input type="reset"/></div></div>
      </div>
    </form>
    </div>
      </div>
...
EOF
#Last Update by Luca 28/04/2016
