...
#in ogni caso stampo l'header (da fare con funzione e file esterno se avanza tempo)
...
if (($estensione =~ /.png/i) || ($estensione =~ /.jpg/i) || ($estensione =~ /.jpeg/i) || ($estensione =~ /.gif/i)){
	...
	if($filename =~ /^([$file_er]+)$/){
		...
		# stampo pagina di errore
			...
			<h1>Informazioni</h1>
				...
				<a href=\"menu.cgi\">Ritorna alla home</a>
					</div></div></div>";
	...
	my $newrecipe = XML::LibXML::Element->new('ricetta');
...
<div id=\"content\">
  <div class=\"main\">
    <h1>Informazioni</h1>
         ...
         <a href=\"proponiricetta.cgi\">Proponi un'altra ricetta!</a>
         <a href=\"menu.cgi\">Ritorna alla home</a>
         </div>
  </div>
  </div>
