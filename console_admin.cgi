...
if($auth eq "amministratoreautenticato")
{
	...
	<div id=\"content\">
		...
		<p>Benvenuto nella Consola Amministrativa.</p>
		<p>Da questa pagina l'amministratore ha la possibilita' di:
		<ul style=\"list-style-type:square\">
			<li>Visualizzare una lista di tutte le ricette attualmente presenti nel sito ed eventualmente eliminarne alcune.</li>
			<li>Visualizzare le ricette in attesa di approvazione e conseguentemente approvarle o rifiutarle.</li>
			<li>Gestire i commenti lasciati sulla pagina \"Contattaci\" ed eliminare eventuali commenti offensivi.</li>
		</ul>
		</p>
	...
	foreach my $recipe (@ricette)
	{
		  ...
		  if($allowed=="1")
		  {
				...
				print "
					<p>
					  <div><a href=\"delete_ricetta.cgi?id=$id\"><input type=\"submit\" value=\"ELIMINA\"></input></a><a href=\"page_template.cgi?id=$id\">$nome</a></div>
				   </p>
				";	
		   }
	}
	...
	if($empty == 0)
	{
		print "<p>Nessun ricetta presente</p>";
	}
